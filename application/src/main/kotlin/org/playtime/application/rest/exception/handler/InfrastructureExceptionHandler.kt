...
@ControllerAdvice
class InfrastructureExceptionHandler : ExceptionHandler() {

    @SpringExceptionHandler(CreateUserException::class)
    private fun handleEntityNotFound(ex: CreateUserException) = buildResponseEntity(
        ApiError(
