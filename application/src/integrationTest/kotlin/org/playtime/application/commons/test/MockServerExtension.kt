 ...
 *
 * <pre>
 * @RegisterExtension static MockServerExtension mockServerExtension =
 * MockServerExtension.builder().resourceLocation("classpath:mockdata/ *.json").build(); </pre> *
 *
 ...
 *
 * <pre> // This variable is needed that the mock server listener starts the mock server
 * @SuppressWarnings("unused") private MockServerClient mockServerClient; </pre> *
 */
class MockServerExtension(private val resourceLocation: String) :
    ...
    override fun beforeEach(context: ExtensionContext) {
        ...
        if (optionalTestClass.isPresent) {
            ...
            val mockServerClient =
                mockServerClientField.get(context.testInstance.get()) as MockServerClient
    ...
    companion object {
        private val MOCK_SERVER_LOGGER: MockServerLogger =
            MockServerLogger(MockServerExtension::class.java)
    }
}
